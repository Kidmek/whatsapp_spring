...
public class MessageController {
    ...
    public ResponseEntity<?> editMessage(@PathVariable("id")Long messageId,@ModelAttribute MessageEditDto messageEditDto){
        return messageService.editMessage(messageId,messageEditDto);
    }

    @PutMapping("react/{id}")
    public ResponseEntity<?> reactToMessage(@PathVariable("id")Long messageId, Long userId, MessageResponse messageResponse){
    ...
    public ResponseEntity<?> getConvMessages(@PathVariable("conversationId")Long conversationId,Long selfId, int page, int size ){
